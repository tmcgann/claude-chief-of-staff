...
if [ "$IS_UPDATE" = true ]; then
    ...
    echo "  skills/               — All skills synced to latest versions"
    echo ""
    ...
    echo "  skills/                       — Skills: gm, triage, my-tasks, enrich,"
...
echo ""
echo -e "${YELLOW}Re-run this script anytime to sync skills to the latest version.${NC}"
echo ""
